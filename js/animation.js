...
tl.fromTo('.circle', {opacity: 0, scale: 0},{opacity: 1, scale: 1})
...
svg.addEventListener('click', () => {
    ...
    t2.fromTo('.circle' , {scale: 1, rotation: '0deg'} , {scale: 1.25, rotation: '-180deg', ease: "circ.in"})
    t2.fromTo('.circle' , {scale: 1.25, rotation: '-180deg'} , {scale: 1, rotation: '-360deg', ease: "circ.out"})
})